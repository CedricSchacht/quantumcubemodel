...
\newcommand{\QCMXINTERNALrenderMeasureQQxINxy}{
  ...
  \draw[red, line width=2mm] (\qcmxOffsetX+2.5, 5+\qcmxOffsetY+1.5, 0) -- (\qcmxOffsetX+2.5, \qcmxOffsetY-1.5, 0);
}
...
\newcommand{\QCMXINTERNALrenderMeasureQQxINxz}{
  ...
  \draw[red, line width=2mm] (\qcmxOffsetX+2.5, \qcmxOffsetY, -5-1.5) -- (\qcmxOffsetX+2.5, \qcmxOffsetY, 1.5);
}
...
\newcommand{\QCMXINTERNALrenderMeasureQQyINxy}{
  ...
  \draw[red, line width=2mm] (5+\qcmxOffsetX+1.5, \qcmxOffsetY+2.5, 0) -- (\qcmxOffsetX-1.5, \qcmxOffsetY+2.5, 0);
}
...
\newcommand{\QCMXINTERNALrenderMeasureQQyINyz}{
  ...
  \draw[red, line width=2mm] (\qcmxOffsetX, \qcmxOffsetY+2.5, 1.5) -- (\qcmxOffsetX, \qcmxOffsetY+2.5, -5-1.5);
}
...
\newcommand{\QCMXINTERNALrenderMeasureQQzINxz}{
  ...
  \draw[red, line width=2mm] (5+\qcmxOffsetX+1.5, \qcmxOffsetY, -2.5) -- (\qcmxOffsetX-1.5, \qcmxOffsetY, -2.5);
}
...
\newcommand{\QCMXINTERNALrenderMeasureQQzINyz}{
  ...
  \draw[red, line width=2mm] (\qcmxOffsetX, \qcmxOffsetY-1.5, -2.5) -- (\qcmxOffsetX, 5+\qcmxOffsetY+1.5, -2.5);
}
