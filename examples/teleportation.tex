...
\begin{qcmx}
    ...
    \draw[black, ->, thick, >=Stealth] (30,-68,0) -- (10,-75,0) 
        node[midway, above, sloped] {\Huge Result: $\ket{00}$};

    \draw[black, ->, thick, >=Stealth] (37,-65,0) -- (30,-75,0) 
        node[midway, below, sloped] {\Huge Result: $\ket{10}$};

    \draw[black, ->, thick, >=Stealth] (43,-71,0) -- (50,-75,0) 
        node[midway, above, sloped] {\Huge Result: $\ket{01}$};

    \draw[black, ->, thick, >=Stealth] (47,-65,0) -- (70,-75,0) 
